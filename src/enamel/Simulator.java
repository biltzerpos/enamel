...
public class Simulator {
    ...
    List<Buttons> hardwareButtonsList = new ArrayList<Buttons>();
    ...
    public Simulator(int brailleCellNumber, int jButtonNumber) {
        ...
        for (int i = 0; i < brailleCellNumber; i++) {
            ...
            pinList.add(pins);
                    ...
                    System.out.println(brailleCellNumber + " " + jButtonNumber);
        ...
        this.hardwareButtonsList.add(new Buttons(4));
        this.hardwareButtonsList.add(new Buttons(5));
        this.hardwareButtonsList.add(new Buttons(6));
        this.hardwareButtonsList.add(new Buttons(7));
    }
     ...
     */
    public void clearAllCells() throws InterruptedException{
    ...
    public Buttons getHardwareButton(int index) {
    	return this.hardwareButtonsList.get(index);
    }
